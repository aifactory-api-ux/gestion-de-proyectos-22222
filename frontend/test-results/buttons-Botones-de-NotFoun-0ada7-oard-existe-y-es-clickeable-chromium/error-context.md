...
- Name: buttons.spec.ts >> Botones de NotFoundPage >> botón Go to Dashboard existe y es clickeable
- Location: tests-functional/buttons.spec.ts:31:3
...
Locator: getByRole('button', { name: /go to dashboard/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /go to dashboard/i })
