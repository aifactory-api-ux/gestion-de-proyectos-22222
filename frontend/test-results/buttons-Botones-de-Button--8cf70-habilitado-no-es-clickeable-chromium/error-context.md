...
- Name: buttons.spec.ts >> Botones de Button Component >> botón deshabilitado no es clickeable
- Location: tests-functional/buttons.spec.ts:105:3
...
Call log:
  ...
  - waiting for locator('button[type="submit"]')
    8 × locator resolved to <button type="submit">Login</button>
