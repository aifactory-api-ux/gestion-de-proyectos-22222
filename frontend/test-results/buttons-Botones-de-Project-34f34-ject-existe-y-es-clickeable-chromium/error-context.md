...
- Name: buttons.spec.ts >> Botones de ProjectForm >> botón Save Project existe y es clickeable
- Location: tests-functional/buttons.spec.ts:55:3
...
Locator: getByRole('button', { name: /save project/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /save project/i })
