...
- Name: buttons.spec.ts >> Botones de Topbar >> botón Logout existe y es clickeable
- Location: tests-functional/buttons.spec.ts:46:3
...
Locator: getByRole('button', { name: /logout/i })
Expected: visible
Timeout: 5000ms
